...
```
git remote set-url origin https://github.com/mathenning/mssqlbeat
...
```
mkdir -p ${GOPATH}/src/github.com/mathenning/mssqlbeat
git clone https://github.com/mathenning/mssqlbeat ${GOPATH}/src/github.com/mathenning/mssqlbeat
```
